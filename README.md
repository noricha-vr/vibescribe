...
- **低コスト** &mdash; 月額約 $1.9（約283円）で使い放題（1日100回 × 30日の場合）
...
| 音声入力（14.7秒 × 32tokens/秒） | 約 470 | $1.00 | $0.00047 |
...
| 使用頻度 | リクエスト数/月 | 月額目安 |
|----------|---------------|---------|
| 1日10回 | 300 | 約 $0.19（約28円） |
| 1日50回 | 1,500 | 約 $0.95（約142円） |
| 1日100回 | 3,000 | 約 $1.89（約283円） |
